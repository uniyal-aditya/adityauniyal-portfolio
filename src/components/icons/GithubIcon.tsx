/** GitHub brand mark — Lucide removed brand icons, so this is a custom SVG
 * matching Lucide's 24×24 style. Used across Building/profile UI. */
export function GithubIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className} focusable="false">
